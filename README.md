...
You don’t need to know anything about programming to use it. The app handles everything behind the scenes, so you just get clear sound and easy playback.
...
- On **Linux**, follow instructions in the ReadMe or open the `.AppImage`.
...
## 🎧 How to Use a1800_codec

Using a1800_codec is easy. Here’s how to play your audio files:
